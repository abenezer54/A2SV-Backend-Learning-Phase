...
// CollectionInteface is an autogenerated mock type for the CollectionInteface type
type CollectionInteface struct {
	mock.Mock
}

// CountDocuments provides a mock function with given fields: ctx, filter, opts
func (_m *CollectionInteface) CountDocuments(ctx context.Context, filter interface{}, opts ...*options.CountOptions) (int64, error) {
...
func (_m *CollectionInteface) DeleteOne(ctx context.Context, filter interface{}, opts ...*options.DeleteOptions) (*mongo.DeleteResult, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *CollectionInteface) Find(_a0 context.Context, _a1 interface{}, _a2 ...*options.FindOptions) (domains.CursorInterface, error) {
	...
	var r0 domains.CursorInterface
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) (domains.CursorInterface, error)); ok {
		return rf(_a0, _a1, _a2...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOptions) domains.CursorInterface); ok {
		r0 = rf(_a0, _a1, _a2...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(domains.CursorInterface)
		}
	}
...
func (_m *CollectionInteface) FindOne(ctx context.Context, filter interface{}, opts ...*options.FindOneOptions) domains.SingleResultInterface {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 domains.SingleResultInterface
	if rf, ok := ret.Get(0).(func(context.Context, interface{}, ...*options.FindOneOptions) domains.SingleResultInterface); ok {
		r0 = rf(ctx, filter, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(domains.SingleResultInterface)
		}
	}
...
func (_m *CollectionInteface) InsertOne(_a0 context.Context, _a1 interface{}, _a2 ...*options.InsertOneOptions) (*mongo.InsertOneResult, error) {
	_va := make([]interface{}, len(_a2))
	for _i := range _a2 {
		_va[_i] = _a2[_i]
	}
...
func (_m *CollectionInteface) UpdateOne(ctx context.Context, filter interface{}, update interface{}, opts ...*options.UpdateOptions) (*mongo.UpdateResult, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// NewCollectionInteface creates a new instance of CollectionInteface. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCollectionInteface(t interface {
	mock.TestingT
	Cleanup(func())
}) *CollectionInteface {
	mock := &CollectionInteface{}
	mock.Mock.Test(t)
